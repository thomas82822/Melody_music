...
from MelodiX.utils.database import get_authuser_names, get_cmode
from MelodiX.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from MelodiX.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await MelodiX.stop_stream(message.chat.id)
    except:
        pass
