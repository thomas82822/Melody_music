...
import config
from MelodiX import Carbon, YouTube, app
from MelodiX.core.call import MelodiX
from MelodiX.misc import db
from MelodiX.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from MelodiX.utils.exceptions import AssistantErr
from MelodiX.utils.inline.play import (stream_markup,
                                          telegram_markup)
from MelodiX.utils.inline.playlist import close_markup
from MelodiX.utils.pastebin import MelodiXbin
from MelodiX.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await MelodiX.force_stop_stream(chat_id)
