...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/thomas82822/Melody_music",
)
...
)  # Example:- https://t.me/TheMelodiX
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", None
)  # Example:- https://t.me/MelodiXSupport
...
# You'll need a Pyrogram String Session for these vars. Generate String from our session generator bot @MelodiXStringBot
...
if False:  # Unicode bot names are allowed
    print(
